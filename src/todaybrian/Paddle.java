...
/* Paddle class defines behaviours for the player-controlled paddles
...
public class Paddle extends Rectangle {
    ...
    // If the paddle is at the top or bottom of the screen, it will not move
    // (checkCollision() will prevent this)
